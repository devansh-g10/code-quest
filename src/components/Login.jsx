    ...
    <div className="login-container">
      <div className="login-card animate-v3">
        ...
        <div className="social-login-options">
          <button className="social-btn google" onClick={() => alert('Google Social Auth (Oauth2) - Mock Implementation')}>
          ...
          <button className="social-btn github" onClick={() => alert('GitHub Social Auth (Oauth2) - Mock Implementation')}>
